 ...
 * transports to implement {@link kr.jclab.grpcoverwebsocket.client.GrpcOverWebsocketClientTransport#ping(PingCallback, Executor)}.
 *
...
public class Ping {
     ...
     */
    public Ping(long data, Stopwatch stopwatch) {
        this.data = data;
    ...
    private static void doExecute(Executor executor, Runnable runnable) {
        try {
            ...
            log.error("Failed to execute PingCallback", th);
        }
    }
