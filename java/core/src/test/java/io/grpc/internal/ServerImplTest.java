...
public class ServerImplTest {
  ...
  @Mock
  private Listener<String> callListener;
  @Mock
  ...
  public void methodNotFound() throws Exception {
    ...
    assertEquals(Code.UNIMPLEMENTED, status.getCode());
    ...
    assertEquals(Code.UNIMPLEMENTED, statusCaptor.getValue().getCode());
  }
  ...
  private ServerStreamListener testStreamClose_setup(
    ...
    createAndStartServer();
    callListener = new Listener<String>() {
      @Override
      public void onReady() {
  ...
  private static class SimpleServer implements InternalServer {
